#   THEME CO-OCCURRENCE NETWORKS IN PALAEOLITHIC ROCK ART (Without "Saiga", "Unknown" and Atxurra figures)
#
...
# --> Remove the "saiga", "unknown" and Atxurra figures
...
dat2 <- dat %>%
  ...
  filter(Theme != "Unknown", Theme != "Saiga", !grepl("^Atr", GU))

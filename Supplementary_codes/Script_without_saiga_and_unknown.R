#   THEME CO-OCCURRENCE NETWORKS IN PALAEOLITHIC ROCK ART (Without "Saiga" and "Unknown" figures)
#
...
# --> Remove the "saiga" and "unknown" figures
...
dat2 <- dat %>%
  ...
  filter(!is.na(Theme), Theme != "Unknown",!is.na(Theme), Theme != "Saiga")
